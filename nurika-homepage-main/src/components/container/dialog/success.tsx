...
import successImage from "@/assets/mint-page/dialog/success.svg";
...
function SuccessDialogContent() {
  return (
    <div className="w-full justify-center items-center flex flex-col space-y-3 p-5 md:p-0">
      <img src={successImage} alt="Success Icon" className="w-14 h-14" />
      <h5 className="text-xl font-bold">Success</h5>
      <p className="text-white/70">You have minted 0.568 MATIC</p>
      <Button className="w-full">View NFT</Button>
    </div>
  );
}
